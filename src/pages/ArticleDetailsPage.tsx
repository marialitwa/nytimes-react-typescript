...
import { Article_ArticleSearch, FetchResult_NotOK, FetchResult_OK } from "../@types/articlesearch";
...
export default function ArticleDetailsPage() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      try {
        const response = await fetch(`https://api.nytimes.com/svc/search/v2/articlesearch.json?fq=_id:"${uri}"&api-key=${apiKey_ArticleSearch}`);
